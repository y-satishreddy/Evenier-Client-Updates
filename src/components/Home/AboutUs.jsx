...
const AboutSection = () => {
  ...
  return (
    <section className="section-padding-60 min-vh-lg-100 min-vh-sm-auto d-flex align-items-center justify-content-center bg-theme-home">
      <div className="container">
        <div className="wpo-section-title no-margin-bottom no-lines responsive-section text-center bg-theme-home">
          {/* <h4>About Us</h4> */}

          <h2
            className="text-dark gilroy-font"
            data-aos="zoom-in"
          ...
          <p className="text-dark-custom gilroy-font">
          ...
          <Link
            to="/about-us"
            title="Know More"
            className="knowmore d-inline-block mt-3 gilroy-font"
          >
            Know More
          </Link>
        </div>
